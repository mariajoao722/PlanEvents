...
public class MainAdapterMonitor extends FirebaseRecyclerAdapter<Eventos,MainAdapterMonitor.myViewHolder> {

    public MainAdapterMonitor(@NonNull FirebaseRecyclerOptions<Eventos> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull MainAdapterMonitor.myViewHolder holder, int position, @NonNull Eventos model) {
