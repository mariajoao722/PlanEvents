...
public class DetalheInscritosMonitor extends AppCompatActivity implements View.OnClickListener{

    private String newString,evento,ID;
    private TextView nome,email,idade,telefone,monitor;

    Button btnLoc,btnVoltar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detalhe_inscritos_monitor);
        // Hide the ActionBar
        ...
        FirebaseDatabase.getInstance().getReference("Users").child(ID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DetalheInscritosMonitor.this, "Algo deu errado!", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnLoc:
                Intent intent = new Intent(DetalheInscritosMonitor.this, MapsActivity8.class);
